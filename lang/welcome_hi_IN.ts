...
<context>
    ...
    <message>
        ...
        <translation>&lt;h3&gt;इंस्टॉल गाइड&lt;/h3&gt;

        &lt;p&gt;आशा है की KaOS का लाइव सत्र अनुभव करने के उपरांत आप कुछ हद तक KaOS से अवगत हो चुके होंगें व इसे इंस्टॉल करना चाहेंगे। पर उससे पहले, आपके लिए कुछ बातें जानना आवश्यक है।&lt;/p&gt;

        &lt;p&gt;प्रत्येक निरंतर अपडेट होने वाले लिनक्स-वितरण की भाँति KaOS को नियमित रूप से अपडेट करना आवश्यक है, स्वाभाविक रूप से दीर्घ अवधि के बाद अपडेट करने से समस्याएं उत्पन्न हो सकती हैं। हम आपको हर सप्ताहांत पर अपडेट करने की सलाह देते हैं और महीने में एक बार तो अपडेट कर ही लें।&lt;/br&gt;
         अगर यह संभव न हो तो हम आपको किसी स्थैतिक लिनक्स-वितरण का उपयोग करने की सलाह देंगें जिसका अपडेट चक्र 6 या 9 महीने का हो। अपडेट सबंधी कोई विशेष सूचना जारी होने की स्थिति में आप उन्हें इस वेबसाइट &lt;a href=&apos;https://kaosx.us/news/&apos;&gt;kaosx.us/news/&lt;/a&gt; पर देख सकते हैं (ये सूचनाएँ पैकेज प्रबंधक Octopi के ख़बरें टैब में भी प्रदर्शित होंगी)। बेहतर होगा कि आप &lt;a href=&apos;https://kaosx.us/docs/pacman/&apos;&gt;पैकेज प्रबंधक पैकमैन&lt;/a&gt; में भी कुछ निपुणता हासिल कर लें। सभी लिनक्स-वितरणों में समय-समय पर बड़े बदलावों की आवश्यकता पड़ती है, ऐसे अवसरों पर उपयोक्ता पैकेज प्रबंधक के सही उपयोग द्वारा ही अपडेट प्रक्रिया की सफलता सुनिश्चित कर सकता है। परिणामतः निरंतर अपडेट होने का अर्थ है निश्चित अवधि पर पुनः इंस्टॉल करने से मुक्ति (स्थैतिक लिनक्स-वितरणों में पुनः इंस्टॉल आवश्यक होते हैं)। ऐसे अवसरों पर पैकमैन का कोई GUI पैकमैन से ज़्यादा विश्वसनीय नहीं हो सकता।&lt;/p&gt;

       &lt;p&gt;KaOS का इंस्टॉलर, Calamares उपयोग के दृष्टि से काफी सरल इंस्टॉलर है, जो फिलहाल केवल एक सुविधा प्रदान नहीं करता है। वह है RAID डिस्क सेटअप करना।&lt;/p&gt;

       &lt;h3&gt;इंस्टॉलर आरंभ करना&lt;/h3&gt;

       &lt;p&gt;प्रथम पृष्ट आपको इंस्टॉलर संबंधी जानकारी, ज्ञात समस्याएँ एवं इंस्टॉल प्रक्रिया हेतु भाषा चयन का विकल्प प्रदान करता है।&lt;/p&gt;

       &lt;p&gt;सुनिश्चित कर लें कि आपका सिस्टम इंस्टॉल हेतु न्यूनतम आवश्यकताएँ की पूर्ति करता हो। इंस्टॉल हेतु इंटरनेट आवश्यक नहीं है व इससे इंस्टॉल बाधित नहीं होगा।&lt;/p&gt;

       &lt;p&gt;ध्यान रहें कि डिस्क स्पेस या उपलब्ध RAM अनुरूप न होने पर इंस्टॉल अवश्य ही असफल होगा। कम-से-कम 20 GB डिस्क स्पेस होना आवश्यक है।&lt;/p&gt;</translation>
    </message>
</context>
<context>
    <name>main</name>
...
<context>
    ...
    <message>
        ...
        &lt;p&gt;नए उपयोक्ता के दृष्टिकोण से ऑपरेटिंग सिस्टम इंस्टॉल करने का सबसे कठिन चरण होता है उपयुक्त फ़ाइल सिस्टम चुन, विभाजन तालिका बनाकर सही विभाजन करना।&lt;/p&gt;

        &lt;p&gt;&lt;font color=&apos;#ff0000&apos;&gt;आगे बढ़ने से पूर्व ड्राइव पर मौजूद महत्वपूर्ण डाटा का बैकअप अवश्य कर लें।&lt;/font&gt;&lt;/p&gt;
        
        &lt;p&gt;अगर आपका लक्षित इंस्टॉल मीडिया (एचडीडी, एसएसडी, यूएसबी आदि) आपकी पसंद के अनुसार फॉर्मेट या विभाजित नहीं है, तो आप इंस्टॉलर द्वारा ऐसा कर सकते हैं, या फिर इंस्टॉल से पहले ऐसा कर लें।&lt;/p&gt;
        
        &lt;p&gt;UEFI व BIOS सिस्टम की अधिक जानकारी हेतु अपना माउस पॉइंटर उनके संबंधित बटन पर ले जाएँ।&lt;/p&gt;
        
        &lt;p&gt;इंस्टॉलर आपको चार विकल्प प्रदान करता है।&lt;/br&gt;
        पहला है मौजूदा विभाजन को छोटा कर, XFS फ़ाइल सिस्टम उपयोग कर KaOS को अपने सिस्टम पर पहले से मौजूद ऑपरेटिंग सिस्टम के साथ इंस्टॉल करें। विस्तृत विभाजन तालिका पर मौजूद या फिर XFS फ़ाइल सिस्टम उपयोग कर रहे विभाजनों को छोटा करना संभव नहीं होता।&lt;/br&gt;
         दूसरा है वर्तमान विभाजन पर मौजूद ऑपरेटिंग सिस्टम व सभी फ़ाइलों को XFS फ़ाइल सिस्टम द्वारा KaOS इंस्टॉल से बदल देना।&lt;/br&gt;
         तीसरा है संपूर्ण डिस्क उपयोग करते हुए एक विभाजन बनाना जिसमें सभी डाटा रुट के अंतर्गत इंस्टॉल होगा, व अन्य सभी विभाजन हटा दिया जाएँगे और फ़ाइल सिस्टम XFS होगा।&lt;/p&gt;

       &lt;p&gt;चौथा विकल्प में आप किसी भी फ़ाइल सिस्टम व विभाजन तालिका का चयन कर सकते हैं। अगर आप ड्राइव को फॉर्मेट कर नया सेटअप करना चाहते हैं या फिर ड्राइव में कोई विभाजन तालिका नहीं है (जैसे नया मीडिया या वर्चुअल बॉक्स इंस्टॉल), तो आप विभाजन तालिका का प्रकार भी चुन सकते हैं। इंस्टॉलर डिफ़ॉल्ट रूप से GPT पर सेट है, ms-dos एक पुराना विकल्प है (BIOS सिस्टमों में यह अधिक प्रचलित है)। लाभ यह है कि GPT असीमित वर्चुअल मुख्य विभाजन उपयोग कर सकता है (ms-dos केवल चार तक ही सीमित है), 2 TB से अधिक क्षमता की ड्राइव में यह चाहिए होता है व UEFI सिस्टम हेतु सबसे बेहतर विकल्प है। अगर आप BIOS सिस्टम पर GPT उपयोग करना चाहते हैं, तो सुनिश्चित कर लें कि आपकी ड्राइव के आरंभ में एक बिना फॉर्मेट हुआ 8 GB का विभाजन हो व उस पर bios_grub फ़्लैग भी सेट हो। इस सेटअप में अलग से कोई /root विभाजन नहीं हो सकता हैं।&lt;/p&gt;

      &lt;p&gt;विभाजन तालिका सेट करने के उपरांत आपको ड्राइव का विभाजन करना होगा, व / (root) हेतु कम-से-कम एक विभाजन होना आवश्यक है। /home हेतु अलग विभाजन होना भी कई बार लाभप्रद होता है एवं अगर आप सिस्टम को स्थगित/सुप्त करना चाहते हैं, तो एक स्वैप विभाजन भी होना चाहिए। इनके अतिरिक्त कोई विभाजन करना आपकी व्यक्तिगत इच्छा है, हालाँकि /usr का सेटअप systemd द्वारा पूर्णतया समर्थित नहीं है (इसके लिए आपको अतिरिक्त कार्य करने होंगे)।&lt;/p&gt;</translation>
    </message>
    <message>
