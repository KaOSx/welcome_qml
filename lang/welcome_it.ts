...
&lt;p&gt;L&apos;idea alla base di KaOS è di creare una distribuzione rolling, solida e ben integrata per poter offrire un ambiente moderno, costruito con cura da zero e con un&apos;idea ben precisa in mente.
 &lt;b&gt;Focus su un DE (KDE), un toolkit (Qt) e un&apos;architettura (x86_64). &lt;/b&gt;
Abbiamo valutato e selezionato gli strumenti e le applicazioni più adatte. Tutto il lavoro è destinato alla creazione dei pacchetti, non allo sviluppo di nuovi strumenti o applicazioni..&lt;/p&gt;

                    &lt;p&gt;Passare da sistemi operativi proprietari a opzioni open source (basate su Linux, BSD o Solaris) è quasi sempre
una questione &lt;b&gt;di libertà e possibilità di scelta&lt;/b&gt;. Ma un sistema operativo o una distribuzione open source non può fare delle scelte verso ciò che ritiene più adatto? KaOS vede in questo una mancanza di attenzione. Per creare una distribuzione di alta qualità è necessario che ci sia un focus per assicurarsi che l&apos;utente ottenga il meglio da qualsiasi scelta faccia. È semplicemente impossibile includere qualsiasi pacchetto per soddisfare ogni Desktop Environment o Toolkit.&lt;/p&gt;
                    
                    &lt;p&gt;KaOS ha scelto di basarsi sul &lt;b&gt;kernel Linux&lt;/b&gt; (anche se il kernel Illumos è continuamente preso in considerazione e auspichiamo un futuro passaggio ad esso). In base a questa scelta, il miglior package manager disponibile, il modo più flessibile di fare package building e di mantenere i repository per una distribuzione rolling come KaOs è &lt;b&gt;pacman/makepkg&lt;/b&gt;. Indipendentemente dal kernel Linux o Illumos, il Desktop Environment sarà sempre KDE e il Toolkit sempre Qt. Forti di queste scelte, nell&apos;aprile del 2013 abbiamo cominciato il package building per questa distribuzione indipendente.&lt;/p&gt;
                    ...
                    &lt;p&gt;Scegliere KDE/QT non significa che KaOS perda di vista l&apos;importanza di avere &lt;b&gt;gli strumenti migliori possibili&lt;/b&gt;. Spesso riteniamo che KDE/Qt offra strumenti superiori, ma ci sono alcune applicazioni in cui l&apos;opzione GTK è l&apos;unica possibile (Inkscape e Ardour per nominarne due), o per esempio nel caso dei browser web l&apos;opzione Qt non sta al passo con le controparti GTK. In queste situazioni, le applicazioni GTK sono disponibili, anche se il loro numero rimarrà limitato. In ogni caso, l&apos;ISO è una dimostrazione delle possibilità di Qt/KDE quindi &lt;b&gt;l&apos;ISO è GTK free&lt;/b&gt;e non sono presenti Firefox, Chrome o LibreOffice ad esempio, poiché dipendono da GTK&lt;/p&gt;
                    
                    &lt;p&gt;La struttura del repository è semplice e consiste di tre gruppi: Core, Main e Apps. Un aggiornamento di sistema ordinario e completo offrirà sempre le ultime novità, &lt;b&gt;senza la necessità di reinstallare&lt;/b&gt; il sistema. &lt;i&gt;Core&lt;/i&gt; contiene i pacchetti di base necessari all&apos;avvio, alla comunicazione con il BIOS, al collegamento dell&apos;hardware di base e all&apos;impostazione base della shell. Tra i pacchetti inclusi ci sono ad esempio il kernel, systemd, toolchain per il building e strumenti da riga di comando di base. &lt;i&gt;Main&lt;/i&gt; contiene tutte le librerie necessarie, i driver extra e i firmware necessari per far funzionare il desktop e le applicazioni. &lt;i&gt;Apps&lt;/i&gt; contiene tutti i pacchetti visti e usati dall&apos;utente, inclusi KDE e gli strumenti necessari. &lt;i&gt;Build&lt;/i&gt; è dove partono tutti i pacchetti, che siano una rebuild, un aggiornamento o un&apos;aggiunta, tutto parte da lì. Una volta superati i test opportuni, i pacchetti sono spostati ai repository rispettivi.&lt;/p&gt;
                    
                    &lt;p&gt;&lt;b&gt;L&apos;utente target&lt;/b&gt; è quello che ha provato diversi sistemi operativi/distributioni/Desktop Environment e ha capito di preferire una distribuzione concentrata a far rendere al meglio un DE; inoltre, a seguito delle ricerche, ha scoperto che il migliore in questo caso è KDE. L&apos;hardware usato è almeno del 2005, in modo che non ci siano problemi con i software a 64 bit. Il pubblico di riferimento non ha problemi ad usare le versioni KDE/Qt delle applicazioni di cui ha bisogno, gradisce veder selezionate le migliori alternative per i propri bisogni, anche se questo significa imparare nuovi modi di lavorare o lavorare con nuove applicazioni. La scelta tra applicazioni simili è ridotta comprensibilmente a 5-6 alternative.&lt;/p&gt;
                    
                    &lt;p&gt;KDE è un Desktop Environment moderno che permette di sfruttare al meglio le capacità di qualsiasi scheda grafica o audio. Questo non significa che KDE non possa girare su hardware scarso, ma in generale ci sono alternative più adatte per questi sistemi (OpenBox per esempio). Il minimo necessario è 8 GB di spazio&lt;b&gt;libero su disco, ma 25 Gb&lt;/b&gt; sono raccomandati; KaOS può essere installato con 1,5 GB di RAM disponibile, anche se l&apos;esperienza sarà molto migliore con almeno &lt;b&gt;2 GB di RAM&lt;/b&gt;. Poiché sono disponibili solo pacchetti x86_64, è necessaria &lt;b&gt;una cpu che supporti registri a 64 bit&lt;/b&gt;. Come per ogni altra distribuzione rolling, gli aggiornamenti sono frequenti e possono anche essere corposi, quindi è necessaria una connessione internet ragionevolmente veloce (il dial-up può risultare difficoltoso) ed è raccomandata una disponibilità mensile di almeno 2 GB.&lt;/p&gt;</translation>
    </message>
</context>
<context>
    <name>guide</name>
