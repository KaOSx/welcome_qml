...
<context>
    ...
    <message>
        ...
        <translation>&lt;h3&gt;Относно KaOS&lt;/h3&gt;
                    &lt;p&gt;Идеята зад KaOS е да се създадете цялостно интегрирана прозрачна rolling дистрибуция на съвременна работна среда,изградена от нулата с много специфичен фокус. Фокусът е върху &lt;b&gt; една десктоп среда (KDE), един инструмент за разработка (Qt), една архитектура (x86_64) &lt;/b&gt;, плюс фокус върху оценка и избиране на най-подходящите инструменти и приложения. Цялата работа е насочена към управлението на инсталационните пакети, а не разработването на нови инструменти или приложения.&lt;/p&gt;
...
<context>
    ...
    <message>
        ...
        <translation>&lt;h3&gt;Ръководство за инсталиране&lt;/h3&gt;
            ...
            &lt;p&gt;Както при всяка rolling дистрибуция, редовното актуализиране е задължително, ако изостанете твърде много и се опитате да актуализирате, вероятно ще възникнат проблеми. Препоръчително е да се актуализира ежеседмично, но не по-рядко от веднъж месечно.&lt;/br&gt;
            Ако това не е възможно за вас, може би е по-добре да помислите за използване на статична дистрибуция с шест или деветмесечен цикъл на издаване. Ако са необходими инструкции за актуализация на KaOS, &lt;a href=&apos;https://kaosx.us/news/&apos;&gt;kaosx.us/news/&lt;/a&gt;винаги ще ви предупреждава (това ще се покаже също и в Octopi, графичната програма за управление на инсталационни пакети). Добре е да се запознаете и с програмата за командния ред &lt;a href=&apos;https://kaosx.us/docs/pacman/&apos;&gt;pacman&lt;/a&gt;. Всяка дистрибуция понякога трябва да въвежда големи промени, а при rolling дистрибуциите трябва да се разчита на мениджъра на пакети, който да взаимодейства с потребителите, за да се гарантира, че тези актуализации се извършват правилно. Тъй като rolling дистрибуция по своята същност означава, че няма преинсталиране на определени интервали от време (статичната дистрибуция използва такова преинсталиране, за да въведе големи промени). Нито един графичен интерфейс за pacman не е толкова мощен, колкото самият pacman в тези ситуации.&lt;/p&gt;
...
<context>
    ...
    <message>
        ...
        <translation>&lt;div&gt;Благодарим ви, че използвате KaOS. Нуждаете се от файл с пароли или списък с пакети?&lt;br&gt;
    ...
    <message>
        ...
        <translation>&lt;p&gt;Правилни пароли за използване в тестовата сесия:&lt;/p&gt;
                            &lt;p&gt;&lt;/p&gt;
                            &lt;table width=100% align=center bgcolor=#eaeaea&gt;
                                &lt;tr&gt;
...
<context>
    ...
    <message>
        ...
        <translation>&lt;p&gt;Използване на четвъртата опция за изтриване на съществуващо разпределение. Изберете &lt;code&gt;Нова таблица на дяловете&lt;/code&gt; за нов диск или за превключване между ms-dos и GPT.&lt;/br&gt;
            Селектирайте &lt;code&gt;Свободно пространство&lt;/code&gt; и изберете &lt;code&gt;Създаване&lt;/code&gt;.  След това получавате прозорец с опции за задаване на тип дял, файлова система и точка на монтиране. Когато използвате инсталиране на UEFI, задължително е да разполагате с VFAT (FAT32) форматиран дял, монтиран в /boot. Най-добре задайте размера на 512MB в началото на таблицата на дяловете. След като root е зададен,  бутонът Напред ще стане отново активен.&lt;/p&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;p&gt;Използване на четвъртата опция за нагласяне на съществуващо разпределение. Изберете &lt;code&gt;Нова таблица на дяловете&lt;/code&gt;за нов диск или за превключване между ms-dos и GPT.&lt;/br&gt;
